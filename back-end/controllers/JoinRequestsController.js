...
exports.approveJoinRequest = async (req, res) => {
    try {
        ...
        // Add user to group members in the same structure as in addUser
        if (!group.members.some(member => member.user_id.toString() === joinRequest.user_id.toString())) {
            group.members.push({ user_id: joinRequest.user_id });
            await group.save();
        }
