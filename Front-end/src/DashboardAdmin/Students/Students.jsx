...
function Students() {
  ...
  useEffect(() => {
    ...
    const allEvaluation = allDataTasks.allAttendace + allDataTasks.allTasks + allDataTasks.allQuiz;
            ...
            {students &&
              students.map((item, index) => (
                <tr key={index}>
                  ...
                  <td className="border">{item.attendanceCount || 0}%</td>
                  <td className="border">{item.tasks || 0}</td>
